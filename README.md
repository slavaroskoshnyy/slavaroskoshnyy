...
Я QA Engineer с опытом работы 1,5 года в области обеспечения качества программного обеспечения. Провожу ручное и автоматизированное тестирование веб сайтов и мобильных приложений, выявляю и документирую дефекты, а также умею анализировать требования. Работаю в Agile-команде и стремлюсь к повышению качества продуктов.
